...
**NEWTON RAPHSON**
```
function[]=RG_NRM(fun,dfun,ddfun,x0,acc,maxitr)
...
term = term + ((del(1,j)/factorial(j))*mult);
end
yr=y(1)+term
fprintf("yr=%f",yr);
```
